...
// the generated parser.go. They define parseProfilingEnabled so the per-line /
// per-event profiling clock and the [PARSE 10s] summary compile out of default
// builds and switch on under -tags sqdparseprof.
